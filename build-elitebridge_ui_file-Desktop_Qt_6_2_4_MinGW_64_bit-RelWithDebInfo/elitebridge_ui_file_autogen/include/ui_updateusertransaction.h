/********************************************************************************
** Form generated from reading UI file 'updateusertransaction.ui'
**
...
#ifndef UI_UPDATEUSERTRANSACTION_H
#define UI_UPDATEUSERTRANSACTION_H
...
class Ui_UpdateUserTransaction
{
public:
    ...
    void setupUi(QDialog *UpdateUserTransaction)
    {
        if (UpdateUserTransaction->objectName().isEmpty())
            UpdateUserTransaction->setObjectName(QString::fromUtf8("UpdateUserTransaction"));
        UpdateUserTransaction->resize(480, 640);
        verticalLayout = new QVBoxLayout(UpdateUserTransaction);
        verticalLayout->setObjectName(QString::fromUtf8("verticalLayout"));
        frame = new QFrame(UpdateUserTransaction);
        ...
        scrollArea = new QScrollArea(UpdateUserTransaction);
        ...
        pushButton = new QPushButton(UpdateUserTransaction);
        pushButton->setObjectName(QString::fromUtf8("pushButton"));

        verticalLayout->addWidget(pushButton);


        retranslateUi(UpdateUserTransaction);

        QMetaObject::connectSlotsByName(UpdateUserTransaction);
    } // setupUi

    void retranslateUi(QDialog *UpdateUserTransaction)
    {
        UpdateUserTransaction->setWindowTitle(QCoreApplication::translate("UpdateUserTransaction", "Dialog", nullptr));
        label->setText(QCoreApplication::translate("UpdateUserTransaction", "User ID               ", nullptr));
        change_password->setText(QCoreApplication::translate("UpdateUserTransaction", "Change Password", nullptr));
        cycle_count->setText(QCoreApplication::translate("UpdateUserTransaction", "Cycle Count", nullptr));
        free_issue_withdraw->setText(QCoreApplication::translate("UpdateUserTransaction", "Free Issue Withdraw", nullptr));
        initiate_stock_transfer->setText(QCoreApplication::translate("UpdateUserTransaction", "Initiate Stock Transfer", nullptr));
        scrap->setText(QCoreApplication::translate("UpdateUserTransaction", "Scrap", nullptr));
        load_rework->setText(QCoreApplication::translate("UpdateUserTransaction", "Load Rework", nullptr));
        move_stock->setText(QCoreApplication::translate("UpdateUserTransaction", "Move Stock", nullptr));
        return_rework_to_general->setText(QCoreApplication::translate("UpdateUserTransaction", "Return from Rework to General", nullptr));
        inventory_adjusment->setText(QCoreApplication::translate("UpdateUserTransaction", "Inventory Adjustment ", nullptr));
        restock_used->setText(QCoreApplication::translate("UpdateUserTransaction", "Restock Used", nullptr));
        change_privileges->setText(QCoreApplication::translate("UpdateUserTransaction", "Change Privileges", nullptr));
        restock_new->setText(QCoreApplication::translate("UpdateUserTransaction", "Restock New", nullptr));
        return_rework_new->setText(QCoreApplication::translate("UpdateUserTransaction", "Return from Rework to New", nullptr));
        retrun_rework_used->setText(QCoreApplication::translate("UpdateUserTransaction", "Return from Rework to Used", nullptr));
        capture_finger_print->setText(QCoreApplication::translate("UpdateUserTransaction", "Capture Fingerprints", nullptr));
        return_rework_scrap->setText(QCoreApplication::translate("UpdateUserTransaction", "Return from Rework to Scrap", nullptr));
        receive_stock_transfer->setText(QCoreApplication::translate("UpdateUserTransaction", "Receive Stock Transfer", nullptr));
        reserve_item->setText(QCoreApplication::translate("UpdateUserTransaction", "Reserve Item", nullptr));
        withdraw_reserved_item->setText(QCoreApplication::translate("UpdateUserTransaction", "Withdraw Reserved Item", nullptr));
        withdraw_kit->setText(QCoreApplication::translate("UpdateUserTransaction", "Withdraw Kit", nullptr));
        receiveAndRestock->setText(QCoreApplication::translate("UpdateUserTransaction", "Receive and Restock", nullptr));
        withdraw_used->setText(QCoreApplication::translate("UpdateUserTransaction", "Withdraw Used", nullptr));
        restock_general->setText(QCoreApplication::translate("UpdateUserTransaction", "Restock General", nullptr));
        withdraw_general->setText(QCoreApplication::translate("UpdateUserTransaction", "Withdraw General", nullptr));
        withdraw_new->setText(QCoreApplication::translate("UpdateUserTransaction", "Withdraw New", nullptr));
        priority_withdraw->setText(QCoreApplication::translate("UpdateUserTransaction", "Priority Withdraw", nullptr));
        withdraw_inspection->setText(QCoreApplication::translate("UpdateUserTransaction", "Withdraw for Inspection", nullptr));
        store_external_request->setText(QCoreApplication::translate("UpdateUserTransaction", "Store External Request", nullptr));
        supervisior_undo->setText(QCoreApplication::translate("UpdateUserTransaction", "Supervisor Undo", nullptr));
        return_general->setText(QCoreApplication::translate("UpdateUserTransaction", "Return to General", nullptr));
        return_key->setText(QCoreApplication::translate("UpdateUserTransaction", "Return Key", nullptr));
        withdraw_external_request->setText(QCoreApplication::translate("UpdateUserTransaction", "Withdraw External Request", nullptr));
        return_used->setText(QCoreApplication::translate("UpdateUserTransaction", "Return to Used", nullptr));
        RFID_insta_track->setText(QCoreApplication::translate("UpdateUserTransaction", "RFID Insta-track", nullptr));
        withdraw_scrap_drawer->setText(QCoreApplication::translate("UpdateUserTransaction", "Withdraw Scrap from Drawer", nullptr));
        return_new->setText(QCoreApplication::translate("UpdateUserTransaction", "Return to New", nullptr));
        return_scrap->setText(QCoreApplication::translate("UpdateUserTransaction", "Return to Scrap", nullptr));
        RFID_STATIC_CABINET_SCAN->setText(QCoreApplication::translate("UpdateUserTransaction", "RFID-Static Cabinet Scan", nullptr));
        return_serialized_item->setText(QCoreApplication::translate("UpdateUserTransaction", "Return Serialized Item", nullptr));
        user_undo->setText(QCoreApplication::translate("UpdateUserTransaction", "User Undo", nullptr));
        return_rework->setText(QCoreApplication::translate("UpdateUserTransaction", "Return to Rework", nullptr));
        weigh_item->setText(QCoreApplication::translate("UpdateUserTransaction", "Weigh Item", nullptr));
        withdraw_scrap_from_bin->setText(QCoreApplication::translate("UpdateUserTransaction", "Withdraw Scrap from Bin", nullptr));
        withdraw_rework_drawer->setText(QCoreApplication::translate("UpdateUserTransaction", "Withdraw Rework From Drawer", nullptr));
        withdraw_rework_from_bin->setText(QCoreApplication::translate("UpdateUserTransaction", "Withdraw Rework from Bin", nullptr));
        pushButton->setText(QCoreApplication::translate("UpdateUserTransaction", "Update Transaction Right", nullptr));
    } // retranslateUi

};

namespace Ui {
    class UpdateUserTransaction: public Ui_UpdateUserTransaction {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_UPDATEUSERTRANSACTION_H
