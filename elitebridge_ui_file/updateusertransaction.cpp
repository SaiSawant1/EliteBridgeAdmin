...
void UpdateUserTransaction::setSelectedValue(QString value){
    selectedValue=value;
    ui->lineEdit->setText(selectedValue);
    setCheckMarks();
}

void UpdateUserTransaction::setCheckMarks(){
    if(ui->lineEdit->text()==""){
    ...
    QSqlQuery query;
    QString selectQuery = "SELECT * FROM Transaction_Rights WHERE userID = ?";
    ...
    if (query.next()) {
      ...
      //  ui->capture_fingerprints->setChecked(query.value("CaptureFingerprints").toString() == "true");
      //  ui->return_from_rework_to_scrap->setChecked(query.value("ReturnfromReworktoScrap").toString() == "true");
       ...
       // ui->receive_and_restock->setChecked(query.value("ReceiveandRestock").toString() == "true");
       ...
       // ui->withdraw_for_inspection->setChecked(query.value("WithdrawforInspection").toString() == "true");
        ui->store_external_request->setChecked(query.value("StoreExternalRequest").toString() == "true");
       // ui->supervisor_undo->setChecked(query.value("SupervisorUndo").toString() == "true");
      //  ui->return_to_general->setChecked(query.value("ReturntoGeneral").toString() == "true");
      ...
      //  ui->return_to_used->setChecked(query.value("ReturntoUsed").toString() == "true");
   //     ui->rfid_insta_track->setChecked(query.value("RFIDInstaTrack").toString() == "true");
      //  ui->withdraw_scrap_from_drawer->setChecked(query.value("WithdrawScrapfromDrawer").toString() == "true");
      //  ui->return_to_new->setChecked(query.value("ReturntoNew").toString() == "true");
      //  ui->return_to_scrap->setChecked(query.value("ReturntoScrap").toString() == "true");
      ...
      //  ui->return_to_rework->setChecked(query.value("ReturntoRework").toString() == "true");
     ...
     //   ui->withdraw_rework_from_drawer->setChecked(query.value("WithdrawReworkFromDrawer").toString() == "true");
        ui->withdraw_rework_from_bin->setChecked(query.value("WithdrawReworkfromBin").toString() == "true");
    }
    db.close();
}

void UpdateUserTransaction::on_pushButton_clicked()
{
    if(ui->lineEdit->text()==""){
        QMessageBox::warning(this, "Field Empty", "Please enter a value in the userID.");
        return ;
    ...
    QString updateQuery = "UPDATE Transaction_Rights SET "
